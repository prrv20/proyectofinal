...
<table class="table">
	...
	<c:forEach items="${mostrarcapacitacion}" var="capacitacion">
	<tr>
		...
		<a title="Eliminar Capacitación" href="EliminarCapacitacion/${capacitacion.getId_capacitacion()}" class="btn  btn-danger"><i class="fas fa-trash"></i></a>&nbsp;
		<a title="Editar Capacitación" href="EditarCapacitacion/${capacitacion.getId_capacitacion()}" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>&nbsp;
	</td>
	</tr>
	</c:forEach>
</table>
...
<a class="btn btn-primary" href="<%=request.getContextPath()%>/MostrarCapacitacion">Actualizar Listado Capacitaciones</a>
