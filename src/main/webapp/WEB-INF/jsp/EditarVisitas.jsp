...
<body>
	<div class="container">
		...
		<form:form method="post" action="/proyectofinalmodulo/GuardarEditarVisita">
			<div class="form-group">
			<form:hidden path="id_visita" class="col-8"/><br /><br />
			</div>
			...
			<input type="submit" value="Guardar Cambios Visita" class="btn btn-success"/>
